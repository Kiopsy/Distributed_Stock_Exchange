...
def test_match_orders():
    ...
    book.add_order("bid", 5, 10, user1)
    book.add_order("bid", 5, 10, user1)
    book.add_order("ask", 5, 15, user2)
    ...
    assert user1.balance == 925, "Incorrect user1 balance after execution"
    assert user1.stocks == 115, "Incorrect user1 stocks after execution"
    assert user2
